...
const SignUpForm = () => {
  ...
  return (
    <div className="bg-gray-900 mt-[1rem] sm:mt-[3rem] md:mt-[5rem] p-4 md:p-10 rounded-lg text-white max-w-2xl mx-auto font-sans">
      ...
      <div className="relative bg-gray-800 rounded flex p-2 md:p-4 my-[10px] md:my-3">
        <input
      ...
      <label className="flex items-center my-4 text-lg">
        ...
        />
        <span className="text-[16px] md:text-lg">I have read and agreed to the Terms and Conditions</span>
