  ...
  return (
    <div className="overflow-y-auto h-full">
      ...
      <div className="flex  w-full  justify-around items-center">
        <div className="text-white text-left mt-[7rem]">
          <h1
          ...
          <pre className="text-lg mb-2 italic gradient-text1">
          ...
          <button
  className="bg-[#124E66] hover:bg-[#0F3A4D] text-white py-2 px-4 rounded"
>
  <Link to="/mentor-signup" className="text-white text-base">
    Join as Mentor
        ...
        <div className="flex justify-center items-center mb-4">
          <img src={Image1} alt="Icon" className="w-[30rem] mt-[7rem]" />
        </div>
      </div>
      <div className="px-5">
        <Mentor/>
