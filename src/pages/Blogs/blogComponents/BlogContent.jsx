      ...
      <div className="content-column-4">
        ...
        <div className="author-container mt-10 mb-10">
          <div className="author-details">
            <h2 className="summary-header text-3xl font-semibold">Summary</h2>
            <p className="summary-text text-left text-gray-400 mt-2">
        ...
        <div className="author-container mt-10 mb-10">
          <div className="author-details">
            <div className="social-links">
              <h2 className="share-header font-semibold">Share This Article</h2>
              <img src={socials} alt="Social Icons" className="social-icons mt-2" />
            </div>
          </div>
        </div>
      </div>
