...
const CardItems = (props) => {
    return (
        <div className='flex items-center justify-center  flex-col rounded-2xl p-[40px] m-0 bg-[#212a31cc] sm:max-w-[300px] max-w-full w-full  hover:rotate-y-360 transition duration-1000 ' >
